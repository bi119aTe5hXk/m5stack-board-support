...
- Enter ```https://raw.githubusercontent.com/bi119aTe5hXk/m5stack-board-support/patch-1/package_m5stack_index.json``` into *Additional Board Manager URLs* field. You can add multiple URLs, separating them with commas.
